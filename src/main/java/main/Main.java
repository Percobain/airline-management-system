...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (running) {
            ...
            System.out.println("2. Passenger Signup/Login");
    ...
    private static void passengerSignup(Scanner scanner) {
        ...
        passengerController.signup(passengerId, name, email, phoneNumber, hasVisa);
    ...
    private static void passengerLogin(Scanner scanner) {
        ...
        if (passengerController.login(passengerId) != null) {
            System.out.println("Passenger login successful.");
            passengerActions(scanner);
        } else {
            System.out.println("Invalid Passenger ID.");
        }
    }

    // Passenger actions like booking flights
    private static void passengerActions(Scanner scanner) {
    ...
    private static void bookFlight(Scanner scanner) {
        ...
        passengerController.bookFlight(flightNumber, passengerController.login(passengerId), seatPreference);
    }
}
